$(function(){
  ...
  $.get(baseUrl + "/orders/user/unpay/"+userId, function(result){
...
function payOrders(ordersId){
    ...
    // });
         window.location.href="/zhifuyemian/index.html?ordersId="+ordersId;
}
